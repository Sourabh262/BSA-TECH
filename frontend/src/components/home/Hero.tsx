      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            >
              <span className="inline-block py-1 px-3 rounded-full bg-blue-100 text-blue-700 font-medium text-sm mb-6 border border-blue-200">
                🚀 Transforming Ideas Into Digital Reality
              </span>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-slate-900 leading-tight mb-6">
                Build The Future With <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-900">BSA TECH</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/contact" className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all transform hover:-translate-y-1 shadow-lg shadow-blue-600/30">
                  Start Your Project
                  <ArrowRight size={20} />
                </Link>
                <Link to="/portfolio" className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-800 border-2 border-slate-200 hover:border-blue-600 px-8 py-4 rounded-full font-semibold text-lg transition-all transform hover:-translate-y-1 shadow-sm hover:shadow">
                  View Our Work
                </Link>
              </div>
            </motion.div>
          ...
          <div className="relative h-[500px] hidden lg:block">
            ...
            <motion.div 
              ...
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -z-10 bg-gradient-to-tr from-blue-200 to-blue-200 w-96 h-96 rounded-full blur-2xl opacity-60 animate-pulse"
            />
          </div>
        </div>
      </div>
